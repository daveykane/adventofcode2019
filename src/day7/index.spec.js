...
describe("Advent of Code - Day Two", () => {
    describe("Part One", () => {
        ...
        it("should output 38500", async () => {
            const input = (await getInput("day7")).split(",").map(Number);
            const result = part1(input);
            expect(result).toEqual(38500);
        });
    });

    describe("Part Two", () => {
        it("should output 139629729", () => {
            const program = [
                3,
                26,
                1001,
            ...
            const result = part2(program);
            expect(result).toEqual(139629729);
        });

        it("should output 18216", () => {
            const program = [
                3,
                52,
                1001,
        ...
        it("should output 33660560", async () => {
            const input = (await getInput("day7")).split(",").map(Number);
            const result = part2(input);
            expect(result).toEqual(33660560);
        });
    });
});
